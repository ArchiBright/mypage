...
const Player = () => {
    ...
    const allSongs = [
        ...
        const renderSongs = (array) => {
            const songsHTML = array.map((song) => {return `<li id="song-${song.id}" className="playlist-song">
            <button onclick="playSong(${song.id} className="playlist-song-info">
